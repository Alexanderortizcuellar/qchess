...
class ChessClient(QWebSocket):
    ...
    def start(self):
        ...
        print(self.state() == QAbstractSocket.ConnectedState)
        print(self.state() == QAbstractSocket.UnconnectedState)
        print(self.state() == QAbstractSocket.ConnectingState)
        print(self.state() == QAbstractSocket.ClosingState)
